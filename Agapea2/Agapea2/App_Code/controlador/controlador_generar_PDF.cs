...
namespace Agapea2.App_Code.controlador
{
    public class controlador_generar_PDF
    {
        ...
        public PdfDocument CrearDocPDF(Dictionary<string, Libro> coleccionLibrosCarrito)
        {
        ...
        private String GenerarFacturaEnHTML(Dictionary<string,Libro> coleccionLibrosCarrito)
        {
            ...
            midocHTML.Append( (from unLibro in coleccionLibrosCarrito select
                                       "<tr>" +
                                       "<td>" + unLibro.Titulo + "</td>" +
                                       "<td>" + unLibro.Autor + "</td></td>").Single());
