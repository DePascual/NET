<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registro.aspx.cs" Inherits="LoginBDATOS.registro" %>
        ...
        <div>
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="buttonBorrar" runat="server" Text="Borrar" OnClick="buttonRegistro_Click" /></td>
                </tr>
            </table>
        </div>
    </form>
